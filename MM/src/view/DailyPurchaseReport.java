...
/**
 * Servlet implementation class DailyPurchaseReport
 */
@WebServlet("/DailyPurchaseReport")
public class DailyPurchaseReport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html>"
				...
				+ "<script src='asset/DailyPurchaseReport.js'></script>"
				+ "</html>");
	}
