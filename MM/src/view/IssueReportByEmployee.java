...
/**
 * Servlet implementation class IssueReportByEmployee
 */
@WebServlet("/IssueReportByEmployee")
public class IssueReportByEmployee extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IssueReportByEmployee() {
        super();
