...
/**
 * Servlet implementation class PurchaseReportByEmployee
 */
@WebServlet("/PurchaseReportByEmployee")
public class PurchaseReportByEmployee extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PurchaseReportByEmployee() {
        super();
